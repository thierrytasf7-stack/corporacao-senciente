...
> **Source:** hybrid-ops-best-practices.md Section 1.2
> **Version:** 1.0.0
> **Updated:** 2026-01-24
...
- `squads/hybrid-ops-squad/processes/ttcx-unified/executor-matrix.yaml`
- `squads/squad-creator/data/hybrid-ops-best-practices.md` Section 1.2
- Pattern Library: HO-EP-001 a HO-EP-004

---

*Squad-Creator Checklist v1.0.0*
*Gerado com base no hybrid-ops-squad reference implementation*
