      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto" style={{ backgroundColor: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
        ...
        <div className="flex items-center justify-between text-[10px]">
          <div className="flex items-center gap-4" style={{ color: 'var(--text-muted)' }}>
            <span>Created: <span style={{ color: 'var(--text-tertiary)' }} suppressHydrationWarning>{formatDate(story.createdAt)}</span></span>
            <span>Updated: <span style={{ color: 'var(--text-tertiary)' }} suppressHydrationWarning>{formatDate(story.updatedAt)}</span></span>
          </div>
