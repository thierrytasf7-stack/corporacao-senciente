...
import { strategyEvolutionService } from './StrategyEvolutionService';
...
export class StrategyService {
  ...
  /**
   * Evolui os parâmetros da estratégia
   */
  async evolveStrategy(
    ...
    try {
      const result = await strategyEvolutionService.evolveStrategy(userId, strategyId, timeframe);
