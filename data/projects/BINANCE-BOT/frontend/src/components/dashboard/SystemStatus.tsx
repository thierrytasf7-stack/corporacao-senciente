...
export const SystemStatus: React.FC = () => {
  ...
  useEffect(() => {
    // Atualizar status baseado na conexão real
    const updateStatus = () => {
      setSystemStatus({
        api: connectionStatus.isConnected ? 'connected' : 'error',
        database: 'connected', // Assumindo que está funcionando
        redis: 'connected', // Assumindo que está funcionando
        websocket: 'checking' // Em desenvolvimento
      });
    };
