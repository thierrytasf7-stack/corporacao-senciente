# Instruções de Uso - Brand Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Brand Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Brand Agent tem e faz

O Brand Agent é um agente especializado em Marca, identidade, posicionamento. Atualmente possui:
...
O Brand Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
