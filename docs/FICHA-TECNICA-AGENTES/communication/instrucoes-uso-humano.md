# Instruções de Uso - Communication Agent (Para Humanos)

## Visão Geral

Este guia explica como usar o Communication Agent. **Nota:** O agente está em estado inicial (V.1) com funcionalidades básicas.
...
#### 2. `search_knowledge`
**O que faz:** Busca no conhecimento especializado de Comunicação interna/externa, PR.
