# Instruções de Uso - Communication Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Communication Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Communication Agent tem e faz

O Communication Agent é um agente especializado em Comunicação interna/externa, PR. Atualmente possui:
...
- Comunicação interna/externa, PR

## Quando Usar Este Agente

### Use o Communication Agent quando:

- Precisa de conhecimento sobre Comunicação interna/externa, PR
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Communication Agent quando:
...
O Communication Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
