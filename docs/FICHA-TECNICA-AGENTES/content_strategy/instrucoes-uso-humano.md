# Instruções de Uso - Content Strategy Agent (Para Humanos)

## Visão Geral

Este guia explica como usar o Content Strategy Agent. **Nota:** O agente está em estado inicial (V.1) com funcionalidades básicas.
...
#### 2. `search_knowledge`
**O que faz:** Busca no conhecimento especializado de Estratégia de conteúdo, SEO, editorial.
