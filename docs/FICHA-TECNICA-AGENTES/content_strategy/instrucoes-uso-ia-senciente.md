# Instruções de Uso - Content Strategy Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Content Strategy Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Content Strategy Agent tem e faz

O Content Strategy Agent é um agente especializado em Estratégia de conteúdo, SEO, editorial. Atualmente possui:
...
- Estratégia de conteúdo, SEO, editorial

## Quando Usar Este Agente

### Use o Content Strategy Agent quando:

- Precisa de conhecimento sobre Estratégia de conteúdo, SEO, editorial
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Content Strategy Agent quando:
...
O Content Strategy Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
