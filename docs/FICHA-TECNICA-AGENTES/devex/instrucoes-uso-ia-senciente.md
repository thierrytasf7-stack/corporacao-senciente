# Instruções de Uso - DevEx Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o DevEx Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o DevEx Agent tem e faz

O DevEx Agent é um agente especializado em Developer experience, CI/CD, automação. Atualmente possui:
...
- Developer experience, CI/CD, automação

## Quando Usar Este Agente

### Use o DevEx Agent quando:

- Precisa de conhecimento sobre Developer experience, CI/CD, automação
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o DevEx Agent quando:
...
O DevEx Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
