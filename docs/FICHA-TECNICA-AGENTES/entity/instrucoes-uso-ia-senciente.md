# Instruções de Uso - Entity Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Entity Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Entity Agent tem e faz

O Entity Agent é um agente especializado em Entidade legal, compliance, registros. Atualmente possui:
...
- Entidade legal, compliance, registros

## Quando Usar Este Agente

### Use o Entity Agent quando:

- Precisa de conhecimento sobre Entidade legal, compliance, registros
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Entity Agent quando:
...
O Entity Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
