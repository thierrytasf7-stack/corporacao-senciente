# Instruções de Uso - Finance Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Finance Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Finance Agent tem e faz

O Finance Agent é um agente especializado em Finanças, custos, ROI, orçamento. Atualmente possui:
...
- Finanças, custos, ROI, orçamento

## Quando Usar Este Agente

### Use o Finance Agent quando:

- Precisa de conhecimento sobre Finanças, custos, ROI, orçamento
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Finance Agent quando:
...
O Finance Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
