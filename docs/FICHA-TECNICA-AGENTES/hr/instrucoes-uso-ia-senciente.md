# Instruções de Uso - HR Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o HR Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o HR Agent tem e faz

O HR Agent é um agente especializado em Recursos humanos, talentos, cultura. Atualmente possui:
...
- Recursos humanos, talentos, cultura

## Quando Usar Este Agente

### Use o HR Agent quando:

- Precisa de conhecimento sobre Recursos humanos, talentos, cultura
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o HR Agent quando:
...
O HR Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
