# Instruções de Uso - Innovation Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Innovation Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Innovation Agent tem e faz

O Innovation Agent é um agente especializado em Inovação, pesquisa, experimentação. Atualmente possui:
...
- Inovação, pesquisa, experimentação

## Quando Usar Este Agente

### Use o Innovation Agent quando:

- Precisa de conhecimento sobre Inovação, pesquisa, experimentação
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Innovation Agent quando:
...
O Innovation Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
