# Instruções de Uso - Legal Agent (Para Humanos)

## Visão Geral

Este guia explica como usar o Legal Agent. **Nota:** O agente está em estado inicial (V.1) com funcionalidades básicas.
...
#### 2. `search_knowledge`
**O que faz:** Busca no conhecimento especializado de Legal, contratos, compliance jurídico.
