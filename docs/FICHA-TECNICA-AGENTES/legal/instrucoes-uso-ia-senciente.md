# Instruções de Uso - Legal Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Legal Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Legal Agent tem e faz

O Legal Agent é um agente especializado em Legal, contratos, compliance jurídico. Atualmente possui:
...
- Legal, contratos, compliance jurídico

## Quando Usar Este Agente

### Use o Legal Agent quando:

- Precisa de conhecimento sobre Legal, contratos, compliance jurídico
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Legal Agent quando:
...
O Legal Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
