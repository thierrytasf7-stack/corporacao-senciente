# Instruções de Uso - Metrics Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Metrics Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Metrics Agent tem e faz

O Metrics Agent é um agente especializado em Métricas, analytics, KPIs, DORA. Atualmente possui:
...
- Métricas, analytics, KPIs, DORA

## Quando Usar Este Agente

### Use o Metrics Agent quando:

- Precisa de conhecimento sobre Métricas, analytics, KPIs, DORA
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Metrics Agent quando:
...
O Metrics Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
