# Instruções de Uso - Partnership Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Partnership Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Partnership Agent tem e faz

O Partnership Agent é um agente especializado em Parcerias, alianças, ecosystem. Atualmente possui:
...
- Parcerias, alianças, ecosystem

## Quando Usar Este Agente

### Use o Partnership Agent quando:

- Precisa de conhecimento sobre Parcerias, alianças, ecosystem
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Partnership Agent quando:
...
O Partnership Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
