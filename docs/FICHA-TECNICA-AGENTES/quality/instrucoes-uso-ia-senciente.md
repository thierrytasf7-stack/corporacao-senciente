# Instruções de Uso - Quality Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Quality Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Quality Agent tem e faz

O Quality Agent é um agente especializado em Qualidade total, melhoria contínua. Atualmente possui:
...
### Use o Quality Agent quando:

- Precisa de conhecimento sobre Qualidade total, melhoria contínua
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Quality Agent quando:
...
O Quality Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
