# Instruções de Uso - Risk Agent (Para Humanos)

## Visão Geral

Este guia explica como usar o Risk Agent. **Nota:** O agente está em estado inicial (V.1) com funcionalidades básicas.
...
#### 2. `search_knowledge`
**O que faz:** Busca no conhecimento especializado de Gestão de riscos, mitigação.
