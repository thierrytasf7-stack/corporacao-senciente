# Instruções de Uso - Sales Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Sales Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Sales Agent tem e faz

O Sales Agent é um agente especializado em Vendas, conversão, funil de vendas. Atualmente possui:
...
- Vendas, conversão, funil de vendas

## Quando Usar Este Agente

### Use o Sales Agent quando:

- Precisa de conhecimento sobre Vendas, conversão, funil de vendas
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Sales Agent quando:
...
O Sales Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
