# Instruções de Uso - Security Agent (Para Humanos)

## Visão Geral

Este guia explica como usar o Security Agent. **Nota:** O agente está em estado inicial (V.1) com funcionalidades básicas.
...
#### 2. `search_knowledge`
**O que faz:** Busca no conhecimento especializado de Segurança, compliance, privacidade.
