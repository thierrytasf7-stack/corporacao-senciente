# Instruções de Uso - Security Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Security Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Security Agent tem e faz

O Security Agent é um agente especializado em Segurança, compliance, privacidade. Atualmente possui:
...
O Security Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
