# Instruções de Uso - Strategy Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Strategy Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Strategy Agent tem e faz

O Strategy Agent é um agente especializado em Estratégia de negócio, planejamento. Atualmente possui:
...
- Estratégia de negócio, planejamento

## Quando Usar Este Agente

### Use o Strategy Agent quando:

- Precisa de conhecimento sobre Estratégia de negócio, planejamento
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Strategy Agent quando:
...
O Strategy Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
