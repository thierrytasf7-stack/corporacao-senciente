# Instruções de Uso - Training Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Training Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Training Agent tem e faz

O Training Agent é um agente especializado em Treinamento, documentação, onboarding. Atualmente possui:
...
- Treinamento, documentação, onboarding

## Quando Usar Este Agente

### Use o Training Agent quando:

- Precisa de conhecimento sobre Treinamento, documentação, onboarding
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Training Agent quando:
...
O Training Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
