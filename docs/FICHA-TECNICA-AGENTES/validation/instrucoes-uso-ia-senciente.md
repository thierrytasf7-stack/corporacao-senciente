# Instruções de Uso - Validation Agent (Para IA-Senciente)

## Visão Geral

Este documento fornece informações técnicas para que outras IAs possam utilizar o Validation Agent. **Nota:** O agente está em estado inicial (V.1).

## Capacidades do Agente

### O que o Validation Agent tem e faz

O Validation Agent é um agente especializado em QA, testes, validação, qualidade. Atualmente possui:
...
### Use o Validation Agent quando:

- Precisa de conhecimento sobre QA, testes, validação, qualidade
- Precisa buscar informações na memória corporativa relacionadas ao domínio
- Precisa de insights básicos sobre o domínio

### NÃO use o Validation Agent quando:
...
O Validation Agent está em estado inicial. Use para busca de conhecimento básico. Para funcionalidades avançadas, aguarde implementação.
