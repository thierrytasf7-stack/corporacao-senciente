...
> **EN** | [PT](../pt/architecture/mcp-system-diagrams.md) | [ES](../es/architecture/mcp-system-diagrams.md)
...
sequenceDiagram
    ...
    CLI-->>User: ✓ Global MCP configured
```
...
sequenceDiagram
    ...
    FS-->>Symlink: linked
    Symlink-->>CLI: success
    CLI-->>User: ✓ Project linked to global config
```
