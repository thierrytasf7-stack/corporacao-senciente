...
- **[Software Inc Game Modding](squads/games-squad/data/software-inc-game-modding.md)** - Guia completo de modding para Software Inc incluindo mecânicas do jogo, APIs de mod, injeção DLL, estruturas XML, compatibilidade e técnicas avançadas
