...
const SpotRotativeAnalysisPanel: React.FC = () => {
    ...
    const fetchStatus = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/spot-rotative-analysis/status`, {
                method: 'POST',
                headers: {
    ...
    const startAnalysis = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/spot-rotative-analysis/start`, {
                method: 'POST',
    ...
    const stopAnalysis = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/spot-rotative-analysis/stop`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' }
            });
    ...
    const updateConfig = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/spot-rotative-analysis/config`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
    ...
    const fetchEmittedSignals = async (page: number = executionsPage) => {
        try {
            const response = await fetch(`${API_BASE_URL}/spot-rotative-analysis/emitted-signals?page=${page}&pageSize=${executionsPageSize}`, {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
    ...
    const fetchCycles = async (page: number = cyclesPage) => {
        try {
            const response = await fetch(`${API_BASE_URL}/spot-rotative-analysis/cycles?page=${page}&pageSize=${cyclesPageSize}`, {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
    ...
    const clearHistories = async () => {
        try {
            ...
            // Limpar execuções
            const execResponse = await fetch(`${API_BASE_URL}/spot-rotative-analysis/clear-executions`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' }
            });

            // Limpar ciclos
            const cyclesResponse = await fetch(`${API_BASE_URL}/spot-rotative-analysis/clear-cycles`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' }
            });
