...
class WebSocketService {
  ...
  connect(): void {
    // WebSocket temporariamente desabilitado - backend não tem WebSocket configurado
    console.log('🔌 WebSocket temporariamente desabilitado - backend não tem WebSocket configurado');
    return;
