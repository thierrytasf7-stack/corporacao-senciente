...
|--------|-------------------|
| @dev | Precisa implementar otimizacao identificada |
| @qa | Precisa validar que fix nao causa regression |
| @data-engineer | Query/schema precisa otimizacao |
| @devops | CI gate de performance precisa configuracao |

---

*AIOS Squad Agent - performance/performance-engineer*
