...
│   └── cost-analysis.md          # Cost-benefit analysis (TODO)
├── data/
│   ├── arcee-trinity-guide.md    # Model capabilities & best practices
│   └── cost-strategies.md        # When to use Aider vs Claude (TODO)
└── scripts/
    ├── aider-invoke.js           # Wrapper to invoke AIDER (TODO)
    └── cost-calculator.js        # Calculate savings (TODO)
```
