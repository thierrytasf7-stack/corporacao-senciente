...
agent:
  ...
  id: aider-optimizer
  title: Cost & Quality Optimizer
  icon: 📊
  whenToUse: 'Optimize cost-quality trade-offs, decide Aider vs Claude, maximize savings'
  customization: |
...
commands:
  - name: help
    description: 'Show all optimization commands'

  - name: analyze-cost
    description: 'Analyze cost-quality for a task (*analyze-cost {task})'

  - name: estimate-savings
    description: 'Estimate total savings for story (*estimate-savings {story-id})'

  - name: decision-matrix
    description: 'Show decision matrix for task types (*decision-matrix)'

  - name: prompt-optimize
    description: 'Optimize prompt for free models (*prompt-optimize {prompt})'

  - name: quality-report
    description: 'Report quality metrics Aider vs Claude (*quality-report)'

  - name: budget-status
    description: 'Show monthly cost & savings status (*budget-status)'

  - name: recommend
    description: 'Recommend Aider or Claude for task (*recommend {task})'

  - name: exit
    description: 'Exit optimizer mode'
