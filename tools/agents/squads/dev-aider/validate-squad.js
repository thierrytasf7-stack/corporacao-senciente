...
class SquadValidator {
  ...
  validateConfig() {
    try {
      ...
      const checks = {
        ...
        hasVersion: /version:\s+1\.1\.0/.test(content),
        ...
        hasPoAider: content.includes('po-aider'),
        hasSmAider: content.includes('sm-aider'),
        hasQaAider: content.includes('qa-aider'),
        hasDeployAider: content.includes('deploy-aider'),
        hasCost: content.includes('cost_model'),
        hasAIOS: content.includes('aios_core') || content.includes('AIOS') || content.includes('aios:'),
        hasWorkflows: content.includes('workflows:'),
        hasChecklists: content.includes('checklists:')
      };
  ...
  validateAgents() {
    const agents = [
      ...
      { file: 'agents/po-aider.md', id: 'po-aider' },
      { file: 'agents/sm-aider.md', id: 'sm-aider' },
      { file: 'agents/qa-aider.md', id: 'qa-aider' },
      { file: 'agents/deploy-aider.md', id: 'deploy-aider' }
    ];
