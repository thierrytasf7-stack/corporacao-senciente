...
> **Source:** Adapted from `hybrid-ops-squad` heuristics
> **Version:** 1.0.0
> **Updated:** 2026-01-24
...
heuristic:
  metadata:
    ...
    agent: "@squad-creator:expansion-creator"
    pattern: "SC-PP-001"
...
- `squads/hybrid-ops-squad/config/heuristics.yaml`
- `squads/squad-creator/data/hybrid-ops-best-practices.md` (Parte 3)

---

*Squad-Creator Core Heuristics v1.0.0*
*Adaptado de hybrid-ops-squad para uso geral em squads*
