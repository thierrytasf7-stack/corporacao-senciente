...
```yaml
template:
  id: expansion-agent-template
  name: Squad Agent (Hybrid Loader)
  quality_standard: "copy-squad + dev-loader"
  min_lines: 800
  ...
  architecture: |
    ...
    - Copy Squad: Full persona/voice/frameworks INLINE (always loaded)
    - Dev/DevOps: Explicit command→file mapping with MANDATORY loading
```
